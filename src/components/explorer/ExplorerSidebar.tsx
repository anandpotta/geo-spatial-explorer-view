...
import { Globe2, Map as MapIcon, Bookmark, Menu } from 'lucide-react';
...
const ExplorerSidebar = ({
  ...
  return (
    <div className={`${isCollapsed ? 'w-16' : 'w-96'} h-full bg-card border-r overflow-hidden flex flex-col transition-all duration-300 ease-in-out`}>
