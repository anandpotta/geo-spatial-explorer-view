        ...
        L.Draw.Marker.prototype.addHooks = function() {
          ...
          if (this.options) {
            this.options.icon = L.icon({
              iconUrl: 'data:image/png;base64,: 'green'
            }
          }
        };
      }
